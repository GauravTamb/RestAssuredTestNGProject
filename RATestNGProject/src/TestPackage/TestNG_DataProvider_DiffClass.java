...
public class TestNG_DataProvider_DiffClass {
	...
	@Test(dataProvider = "requestBody" , dataProviderClass=Repository.RequestBody.class , description = "Data_Provider_Different_Class_Test")
	public void validator(String Req_name , String Req_job) throws IOException {
		...
		//Evidence Creation
		Utility.evidenceFileCreator(Utility.testLogName("Data_Provider_Different_Class_Evidence"), dir_name, Endpoint, requestBody,
